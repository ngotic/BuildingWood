...
public class TeachDTO {
	...
	public void setTeachseq(String teachseq) {
		this.teachseq = teachseq;
	}
	...
	public String getAteachseq() {
		return ateachseq;
	}

	public void setAteachseq(String ateachseq) {
		this.ateachseq = ateachseq;
	}
