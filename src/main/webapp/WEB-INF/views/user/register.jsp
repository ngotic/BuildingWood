            ...
            <div class="register_container">
               ...
               <form id="form1" action="/wood/user/register.do" method="POST" enctype="multipart/form-data">
	                <div>
	                    ...
	                    <input type="text" class="register_input" id="id" name="id" placeholder="아이디를 입력해주세요.">
	                </div>
	                <div class="row">
	                	<div class="col">
		                    <label for="pw" class="form-label">비밀번호*</label> 
		                    <input type="password" class="register_input is-valid" id="pw" name="pw" placeholder="비밀번호를 입력해주세요.">
		                    <div class="valid-feedback"></div>
	                    </div>
	                    <div class="col">
		                    <label for="pwcheck" class="form-label">비밀번호 확인*</label>
		                    <input type="password" class="register_input is-valid" id="pwcheck" name="pwcheck" placeholder="비밀번호를 한번 더 입력해주세요.">
	                ...
	                <div>
	                    ...
	                    <input type="text"  class="register_input" id="email" name="email" placeholder="진짜 되는 이메일을 입력해주세요.">
	                </div>
